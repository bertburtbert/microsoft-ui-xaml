...
winrt::IAnimatedVisual AnimatedVisuals::Controls_09_Hamburger::TryCreateAnimatedVisual(
...
double AnimatedVisuals::Controls_09_Hamburger::FrameToProgress(double frameNumber)
{
    return frameNumber / 60.0;
}

winrt::Windows::Foundation::Collections::IMapView<winrt::hstring, double> AnimatedVisuals::Controls_09_Hamburger::Markers()
{
...
void AnimatedVisuals::Controls_09_Hamburger::SetColorProperty(winrt::hstring const&, Color)
{
}

void AnimatedVisuals::Controls_09_Hamburger::SetScalarProperty(winrt::hstring const&, double)
{
}
